        ...
        <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">{user.nombre_completo}</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{user.rol === 'administrador' ? 'Administrador' : 'Estudiante'}</p>
                  </div>
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-900">{new Date(user.fecha_registro).toLocaleDateString('es-ES')}</p>
                  </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              ...
              {courses.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">No hay cursos inscritos</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {courses.map((course) => (
                    <div key={course.id_curso} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h5 className="font-semibold text-gray-900 mb-1">{course.titulo}</h5>
                          <p className="text-sm text-gray-600 mb-3">{course.descripcion}</p>
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div className="flex justify-end">
              <button
                onClick={onClose}
                className="px-6 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition-all duration-200"
              >
                Cerrar
              </button>
            </div>
